...
export default function TVDisplayCD({ code }: TVDisplayCDProps) {
  ...
  const displayData = useMemo(() => {
    ...
    const getCDColor = (idx: number) => {
      const cdColors = [
        {
          // CD1: Teal - Darker and more harmonious than Emerald
          bgColor: "bg-teal-700",
          textColor: "text-white",
          rowBg: "bg-teal-900/20",
          parentRowBg: "bg-teal-900", // Solid dark background for parent
          borderColor: "border-teal-700/40",
        },
        {
          // CD2: Violet - Deep violet for better contrast
          // bgColor: "bg-violet-600",
          bgColor: "bg-teal-700",
          textColor: "text-white",
          rowBg: "bg-violet-800/20",
          parentRowBg: "bg-violet-800",
...

        {
          ...
          parentRowBg: "bg-pink-900",
          borderColor: "border-pink-700/40",
        },
        {
          // CD4: Blue - Classic dark cyan
          // bgColor: "bg-cyan-700",
          bgColor: "bg-teal-700",
          textColor: "text-white",
          rowBg: "bg-cyan-900/20",
          parentRowBg: "bg-cyan-900",
  ...
  const getDbColor = (db: number, nc: number): string => {
    if (nc === 0) return "";
    const ratio = db / nc;
    if (ratio > 1.0) return "bg-fuchsia-500";
    if (ratio >= 0.95) return "bg-green-500";
    if (ratio >= 0.9) return "bg-yellow-400 text-black";
  ...
  return (
    ...
    >
      {/* Header */}
      <div
        className="w-full flex flex-row items-center gap-3 px-4 flex-shrink-0 border-b-2 border-slate-700 tv-header"
        style={{ height: "6vh" }}
      >
        <div
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="font-black text-white text-center text-[1.6rem] leading-tight">
            THTXTS - ĐHSX CHẶT DÁN & TIẾN ĐỘ ĐỒNG BỘ CUNG ỨNG ĐẦU VÀO CHO MAY -{" "}
            {displayData.factory}
          </div>
        </div>
        <div
          className="w-24 text-right font-bold text-[1.6rem] text-white"
      ...
      {/* Main - 3 Sections */}
      <div className="flex-1 overflow-hidden flex flex-row gap-1 px-1 bg-slate-900">
        {/* SECTION 1: KẾ HOẠCH GIAO & SẢN LƯỢNG - 30% */}
        <div
          className="flex flex-col border-2 border-slate-700 overflow-hidden rounded bg-slate-800 gap-1"
          style={{ width: "30%" }}
        >
          {/* Header */}
          <div
            className="bg-slate-700 border-b-2 border-slate-600 text-center flex items-center justify-center flex-shrink-0"
            style={{ height: "5vh" }}
          >
            <h2
          ...
          {/* Table Headers */}
          <div
            className="w-full flex border-b-2 border-slate-600 bg-slate-700 flex-shrink-0"
            style={{ height: "6vh" }}
          >
            {/* <div
              className="border-r border-slate-600 font-bold text-center flex items-center justify-center leading-tight px-1 text-white"
              style={{ width: "10%", fontSize: getDynamicFontSize(0.65) }}
            >
              CD
            </div> */}
            <div
              className="border-r border-slate-600 font-bold text-center flex items-center justify-center leading-tight text-white"
            ...
            <div
              className="font-bold text-center flex items-center justify-center leading-tight text-white"
          ...
          <div className="flex-1 overflow-hidden">
            <div className="w-full h-full flex flex-col">
              {displayData.monthlyPlan.map((plan: any, idx: number) => {
                ...
                const rowBg = cdGroup?.parentRowBg || "bg-slate-800";
                ...
                return (
                  ...
                  >
                    {/* <div style={{ height: "8%" }} /> */}
                    <div
                      className={`flex flex-row w-full border ${borderColor}`}
                    ...
                    >
                      ...
                      {/* Data columns */}
                      <div
                        className={`border-r ${borderColor} flex items-center justify-center font-semibold text-center text-white h-full ${getFlashClass(
                          `s1-${idx}-khGiaoThang`
                        )}`}
                        style={{
                      ...
                      <div
                        className={`flex items-center justify-center font-semibold text-center text-white h-full ${getFlashClass(
                          `s1-${idx}-bqCanSxNgay`
                        )}`}
                        style={{
                          fontSize: getDynamicFontSize(1.2),
        ...
        >
          ...
          >
            <thead>
              <tr
                className="bg-slate-700 border-b-2 border-slate-600"
                style={{ height: "6vh" }}
              >
                <th
                  className="border-r border-slate-600 font-bold text-center text-white px-1"
                ...
                <th
                  className="border-r border-slate-600 font-bold text-center leading-tight text-white"
                  style={{
                    width: "8%",
              ...
              <tbody>
                {displayData.cdGroups.map((cd: any) =>
                  cd.rows.map((row: any, rowIdx: number) => {
                    ...
                    const currentRowBg =
                      rowIdx === 0 ? cd.bgColor : "bg-slate-800";
                    ...
                    return (
                      <tr
                        ...
                        className={`${currentRowBg} border-b`}
                      ...
                      >
                        ...
                        <td
                          ...
                          className={`border-r border-b text-center  px-1 overflow-hidden border-slate-400 ${getFlashClass(
                        ...
                        <td
                          className={`border-r border-b text-white border-slate-400 font-semibold text-center overflow-hidden whitespace-nowrap ${getFlashClass(
                            `s2-${displayData.cdGroups.indexOf(
                              cd
                            )}-${rowIdx}-maHang`
                          )}`}
                        ...
                        <td
                          className={`border-r border-b border-slate-400 font-semibold text-center text-white overflow-hidden whitespace-nowrap ${getFlashClass(
                            `s2-${displayData.cdGroups.indexOf(
                              cd
                            )}-${rowIdx}-mau`
                          )}`}
                        ...
                        <td
                          className={`border-r border-b border-slate-400 font-semibold text-center text-white overflow-hidden ${getFlashClass(
                            `s2-${displayData.cdGroups.indexOf(
                              cd
                            )}-${rowIdx}-tglv`
                          )}`}
                        ...
                        <td
                          className={`border-b border-slate-400 font-bold text-center overflow-hidden ${getPercentageColorClass(
                            percentage
                          )} ${getFlashClass(
                            `s2-${displayData.cdGroups.indexOf(
                              cd
        ...
        >
          ...
          <div className="flex flex-row overflow-hidden gap-1">
            ...
            >
              <thead>
                <tr
                  className="bg-slate-500 border-b-2 border-slate-400"
                  style={{ height: "7vh" }}
                >
                  <th
                    className="border-r border-slate-600 font-bold text-center leading-tight text-white"
            ...
            >
              <thead>
                <tr
                  className="bg-slate-600 border-b-2 border-slate-600"
                  style={{ height: "6vh" }}
                >
                  {/* <th
                  className="border-r border-slate-600 font-bold text-center leading-tight text-white"
                  style={{ width: "10%", fontSize: getDynamicFontSize(0.9) }}
                >
                  {nextDays[0]}
                  <br />
                  NCĐV
            ...
            >
              <thead>
                <tr
                  className="bg-slate-600/40 border-b-2 border-slate-400"
                  style={{ height: "6vh" }}
                >
                  <th
                    className="border-r border-slate-400 font-bold text-center leading-tight text-white"
                    style={{ width: "20%", fontSize: getDynamicFontSize(0.9) }}
                  >
                    {nextDays[2]}
                    <br />
                ...
                {displayData.cdGroups.map((cd: any, cdIdx: number) =>
                  cd.rows.map((row: any, rowIdx: number) => {
                    ...
                    return (
                      <tr
                        key={`${cdIdx}-${rowIdx}`}
                        className={`${currentRowBg} border-b border-slate-400`}
                        style={{ height: getRowHeight() }}
                      >
                        <td
                          className={`border-r border-b border-slate-400 font-semibold text-center text-white overflow-hidden ${getFlashClass(
                        ...
                        <td
                          className={`border-r border-b border-slate-100 font-bold text-center overflow-hidden ${
                            row.dbNgay
                        ...
                        <td
                          className={`border-r border-b border-slate-100 font-semibold text-center 
                  ...
                  cd.rows.map((row: any, rowIdx: number) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td
                          className={`border-r border-b border-slate-100 font-bold text-center  overflow-hidden ${getDbColor(
                            supplyRow.db1,
                            supplyRow.nc1
                  ...
                  cd.rows.map((row: any, rowIdx: number) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td
                          className={`border-b border-slate-100 font-bold text-center overflow-hidden ${getDbColor(
                            supplyRow.db3,
                            supplyRow.nc3
